...
using API.Application.Catalog.Brands;
using API.Application.Common.Interfaces;
using API.Application.Common.Persistence;
using API.Domain.Catalog;
using API.Shared.Notifications;
using Hangfire;
...
namespace API.Infrastructure.Catalog;
